(ns chatty.clojure.reader.metadata-test
  (:refer-clojure :exclude [read *default-data-reader-fn* read-string])
  (:use [chatty.clojure.reader :only [read *default-data-reader-fn* read-string]]
        [clojure.test :only [deftest is]])
  (:require [chatty.clojure.reader.reader-types :as reader-types]
...
(def test-contents
  ...
  "(ns chatty.clojure.reader.haiku)\n\n(defn haiku
...
(def expected-haiku-ns
  (with-meta  '(^{:line 1 :column 2 :end-line 1 :end-column 4 :file "haiku.clj"} ns
                ^{:line 1 :column 5 :end-line 1 :end-column 32 :file "haiku.clj"} chatty.clojure.reader.haiku)
    {:line 1 :column 1 :end-line 1 :end-column 33 :file "haiku.clj"}))
...
(deftest read-metadata
  (let [reader (-> (test-reader)
    ...
    (is (= {:line 1 :column 1 :end-line 1 :end-column 33 :file "haiku.clj"} (meta first-form)))
...
(def expected-haiku-ns-with-source
  (with-meta  '(^{:line 1 :column 2 :end-line 1 :end-column 4 :source "ns" :file "haiku.clj"} ns
                ^{:line 1 :column 5 :end-line 1 :end-column 32 :source "chatty.clojure.reader.haiku" :file "haiku.clj"} chatty.clojure.reader.haiku)
    {:line 1 :column 1 :end-line 1 :end-column 33 :source "(ns chatty.clojure.reader.haiku)" :file "haiku.clj"}))
...
(deftest read-metadata-with-source
  (let [reader (-> (test-reader)
        ...
        first-form (read reader)
        second-form (read reader)]
    (is (= {:line 1 :column 1 :end-line 1 :end-column 33 :source "(ns chatty.clojure.reader.haiku)" :file "haiku.clj"} (meta first-form)))
